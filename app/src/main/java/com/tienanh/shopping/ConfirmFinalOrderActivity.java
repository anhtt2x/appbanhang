...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Tổng tiền :"+totalAmount+" VNĐ",Toast.LENGTH_SHORT).show();
    ...
    private void Check() {
        if(TextUtils.isEmpty(nameEditText.getText().toString())){
            Toast.makeText(this,"Nhập tên đầy đủ của bạn",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(phoneEditText.getText().toString())){
            Toast.makeText(this,"Nhập số điện thoại của bạn",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(addressEditText.getText().toString())){
            Toast.makeText(this,"Nhập địa chỉ hợp lệ của bạn",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(cityEditText.getText().toString())){
            Toast.makeText(this,"Nhập tên thành phố của bạn",Toast.LENGTH_SHORT).show();
        }
        else {
