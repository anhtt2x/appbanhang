...
import com.tienanh.shopping.Model.AdminOrders;
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull final AdminOrders model) {
                        ...
                        holder.userName.setText("Tên khách hàng: "+model.getName());
                        ...
                        holder.userShippingAddress.setText("Địa chỉ giao hàng: "+model.getAddress()+", "+model.getCity());
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setTitle("Bạn có muốn vận chuyển sản phẩm theo đơn đặt hàng này không?");
