...
public class SettinsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        Toast.makeText(SettinsActivity.this, "Cập nhật thông tin hồ sơ thành công.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    private void userInfoSaved()
    {
        ...
        {
            Toast.makeText(this, "Nhập địa chỉ của bạn", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(userPhoneEditText.getText().toString()))
        {
            Toast.makeText(this, "Nhập sđt của bạn", Toast.LENGTH_SHORT).show();
        }
    ...
    private void uploadImage() {
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(SettinsActivity.this, "Lỗi.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
        ...
        {
            Toast.makeText(this, "hình ảnh không được chọn.", Toast.LENGTH_SHORT).show();
        }
